...
SafeShape готовит релиз `3.2.0`; последняя опубликованная версия — 3.1.0.
...
В рабочую версию добавлены композиция объектов, проверяемые цепочки преобразований,
рекурсивные декларации TypeScript и проверки связей producer/consumer. Эти
возможности ещё не входят в опубликованную 3.1.0. См.
